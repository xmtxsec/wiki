...
# 0x01 日志简介
日志默认存放位置：/var/log/<br />查看日志配置情况：more /etc/rsyslog.conf
...
比较重要的几个日志：<br />登录失败记录：/var/log/btmp     //lastb<br />最后一次登录：/var/log/lastlog  //lastlog<br />登录成功记录: /var/log/wtmp     //last<br />登录日志记录：/var/log/secure

目前登录用户信息：/var/run/utmp  //w、who、users

历史命令记录：history<br />仅清理当前用户： history -c
...
**2、/var/log/yum.log**<br />软件安装升级卸载日志：
```
yum install gcc

...
```
![image-20210623145737210.png](./assets/1655882858951-e92c689d-e9b5-450a-bb44-fd0363b2bc46.png)

在浏览器中按F12更改前端限制<br />![image-20210623150201179.png](./assets/1655882863662-3a3de18b-eb33-4980-9e54-6d10a135f107.png)

![image-20210623150255375.png](./assets/1655882867172-a03a8dda-ed7f-4dfb-894a-aa742bb8a29a.png)
...
## 实战
输入账号和密码登录<br />![image-20210623151840344.png](./assets/1655882885541-7ef3bb57-0436-42c5-adfc-be8949b1f0e8.png)
...
成功弹窗<br />![image-20210623151930881.png](./assets/1655882891634-b01aee64-79ae-49a5-aa1d-a482f0189ed9.png)
...
## 模拟实战
在攻击机里面搭建pikachu靶场进入管理工具里的XSS后台，初始化数据库<br />![image-20210625144227777.png](./assets/1655882923935-78dee977-8444-44f8-8b18-9378b8bd39a9.png)

修改pikachu/pkxss/xcookie下的cookie.php，将**IP地址改为漏洞服务器的地址**<br />![image-20210625144334470.png](./assets/1655882928116-4b449c7b-e0ca-4bab-90ba-d98dc4d1af6b.png)
...
当用户提交我们的payload时，成功获取到受害者的cookie<br />![image-20210625144527897.png](./assets/1655882935129-d6a83cf9-3da5-4bac-8e36-ddd45129b06a.png)

![image-20210625145112717.png](./assets/1655882938928-495856ae-fb9b-4949-8ab3-ca781b9641f9.png)
...
成功获取到cookie<br />![image-20210625145211023.png](./assets/1655882946004-6b5d83dd-c891-46c6-8a85-fdd4e06f5bac.png)
...
```
![image-20210623160827097.png](./assets/1655882968950-05fbae24-b916-4a11-bd5e-2303a97ce4aa.png)

提交后成功弹窗，返回cookie值<br />![image-20210623160906350.png](./assets/1655882972621-ce806cfa-05b7-4608-af4c-25358f3332df.png)
...
## 模拟实战
修改pikachu/pkxss/xfish 下的 fish.php 文件，**将IP地址改为攻击者的服务器地址**<br />![image-20210625145736122.png](./assets/1655882986635-b2924abf-7ff2-42b8-8fa2-c43fad1b830e.png)
...
访问漏洞服务器进行留言<br />![image-20210625150053697.png](./assets/1655882995215-df806782-21d6-46b7-b2bb-13dce0758bba.png)

模拟受害者访问漏洞服务器，会弹出一个登录窗口<br />![image-20210625160550573.png](./assets/1655883000430-b9673230-d8ca-4dd3-9704-a04dd94322f5.png)

若用户输入账号和密码我们就能够在攻击机上得到用户的账号和密码<br />![image-20210625160637863.png](./assets/1655883004560-cc987766-a618-420c-952b-b8ad72cf049f.png)
...
结果没有任何反应，按F12在查看器中查看，可以看到字符串拼接写到了 a 标签的 href 属性中，a标签会写到 Id 为 dom的 div 标签中<br />![image-20210625165506803.png](./assets/1655883018768-8c733db3-ffaf-4383-8394-88df2b77c5f8.png)
...
成功弹窗<br />![image-20210625170039757.png](./assets/1655883027650-e287b791-1f28-4a96-9f9d-7849e2f9881b.png)
...
结果没有任何反应，按F12在查看器中查看，和上面的如出一辙，字符串拼接写到了 a 标签的 href 属性中，a标签会写到 Id 为 dom的 div 标签中<br />![image-20210625170708736.png](./assets/1655883045033-2c25ca02-cb88-4e40-9507-6144db7c5f0c.png)
...
成功弹窗<br />![image-20210625170826856.png](./assets/1655883051352-83de4caa-7957-41ff-bc62-c072cab80a22.png)
...
没有任何反应<br />![image-20210625172016391.png](./assets/1655883069462-79eda5e4-9db8-47e0-a878-72d993016bb4.png)

通过代码我们可以看到数据是被保存到后台数据库中的，在前端没有反应，通过提醒我们可以看到是要登录网站后台进行查看,成功弹窗<br />![image-20210625172635568.png](./assets/1655883073683-f832561d-9f1f-4493-ac5b-3b402447f57e.png)
...
成功弹窗<br />![image-20210626142747315.png](./assets/1655883091982-c60c7485-9800-4408-9b43-5056fa509130.png)
...
<script>alert("LSAQ-XMTX")</script>
```
![image-20210626145032822.png](./assets/1655883114405-a8dd7570-c728-4b2e-b9e9-6e706a6ed586.png)
...
成功弹窗<br />![image-20210626150126860.png](./assets/1655883119599-3ddc1360-0b88-478e-b925-e30583b95122.png)
...
成功弹窗<br />![image-20210626151621202.png](./assets/1655883140536-3c1eab7e-c840-41e2-b1eb-b5184dce3cdf.png)
...
没有任何反应，按F2查看，可以看到输入的内容被闭合在`<script>`标签中<br />![image-20210626152128217.png](./assets/1655883153811-35276f02-20fd-4142-b046-71ace52e73ec.png)
...
成功弹窗<br />![image-20210626152330171.png](./assets/1655883158749-b87988c8-3e36-4a1f-aa2e-b4af99907637.png)
